...
export default function DeleteTodo({ close, todo_id }: DeleteTodoProps) {
  ...
  return (
    <section className='absolute h-full w-full bg-black/50 flex items-center justify-center top-0 left-0'>
      <div className='shadow-lg rounded-lg border-2 border-gray-700 bg-gray-500 md:text-xl p-4'>
        ...
        <div className='mt-4 w-full flex items-center justify-center gap-4'>
          ...
          <button onClick={close} className='bg-green-600 text-lg py-1 px-4 rounded text-center'>No</button>
        </div>
      </div>
    </section>
  )
